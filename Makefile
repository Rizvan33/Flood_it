...
temps : temps.o Liste_case.o  API_Grille.o API_Gene_instance.o Fonctions_exo1.o S_Zsg.o
	gcc -o bin/temps temps.o Liste_case.o API_Grille.o API_Gene_instance.o Fonctions_exo1.o S_Zsg.o  -I include -L lib -lmingw32 -lSDL2main -lSDL2
